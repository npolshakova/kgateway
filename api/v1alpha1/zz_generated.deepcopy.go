...
func (in *AI) DeepCopyInto(out *AI) {
	*out = *in
	in.PromptEnrichment.DeepCopyInto(&out.PromptEnrichment)
	in.PromptGuard.DeepCopyInto(&out.PromptGuard)
	if in.Defaults != nil {
...
func (in *LLMBackend) DeepCopyInto(out *LLMBackend) {
	*out = *in
	in.LLMProviders.DeepCopyInto(&out.LLMProviders)
	if in.MultiPool != nil {
...
func (in *Moderation) DeepCopyInto(out *Moderation) {
	*out = *in
	out.OpenAIModeration = in.OpenAIModeration
}
...
func (in *PromptguardRequest) DeepCopyInto(out *PromptguardRequest) {
	*out = *in
	out.CustomResponse = in.CustomResponse
