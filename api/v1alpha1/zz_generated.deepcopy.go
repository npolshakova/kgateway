...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentGatewayIntegration) DeepCopyInto(out *AgentGatewayIntegration) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentGatewayIntegration.
func (in *AgentGatewayIntegration) DeepCopy() *AgentGatewayIntegration {
	if in == nil {
		return nil
	}
	out := new(AgentGatewayIntegration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubernetesProxyConfig) DeepCopyInto(out *KubernetesProxyConfig) {
	*out = *in
	...
	if in.AgentGatewayIntegration != nil {
		in, out := &in.AgentGatewayIntegration, &out.AgentGatewayIntegration
		*out = new(AgentGatewayIntegration)
		(*in).DeepCopyInto(*out)
	}
}
