...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterMatcher) DeepCopyInto(out *FilterMatcher) {
	*out = *in
	if in.Exact != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterMatcher.
func (in *FilterMatcher) DeepCopy() *FilterMatcher {
	if in == nil {
		return nil
	}
	out := new(FilterMatcher)
	in.DeepCopyInto(out)
	return out
}
