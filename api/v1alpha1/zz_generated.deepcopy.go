...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CELConditions) DeepCopyInto(out *CELConditions) {
	*out = *in
	if in.CelMatchExpression != nil {
		in, out := &in.CelMatchExpression, &out.CelMatchExpression
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CELConditions.
func (in *CELConditions) DeepCopy() *CELConditions {
	if in == nil {
		return nil
	}
	out := new(CELConditions)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTValidation) DeepCopyInto(out *JWTValidation) {
	*out = *in
	out.ExtensionRef = in.ExtensionRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTValidation.
func (in *JWTValidation) DeepCopy() *JWTValidation {
	if in == nil {
		return nil
	}
	out := new(JWTValidation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Principal) DeepCopyInto(out *Principal) {
	*out = *in
	if in.JWTPrincipals != nil {
		in, out := &in.JWTPrincipals, &out.JWTPrincipals
		*out = make(map[string]*JWTPrincipal, len(*in))
		for key, val := range *in {
			var outVal *JWTPrincipal
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
