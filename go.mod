...
require (
	...
	github.com/agentgateway/agentgateway v0.7.1
...
replace (
	github.com/agentgateway/agentgateway => github.com/npolshakova/agentgateway v0.0.0-20250807145145-c8210e3547c9
