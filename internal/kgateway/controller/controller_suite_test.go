...
func createManager(
	...
	if classConfigs == nil {
		classConfigs = map[string]*deployer.ClassInfo{}
		classConfigs[altGatewayClassName] = &deployer.ClassInfo{
			Description: "alt gateway class",
		}
		classConfigs[gatewayClassName] = &deployer.ClassInfo{
			Description: "default gateway class",
		}
		classConfigs[selfManagedGatewayClassName] = &deployer.ClassInfo{
