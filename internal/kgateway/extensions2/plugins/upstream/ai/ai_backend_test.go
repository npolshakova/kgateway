...
func TestApplyAIBackend(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedTypedConfig: &map[string]proto.Message{
				...
				wellknown.AIUpstreamTransformationFilterName: &envoytransformation.RouteTransformations{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ApplyAIBackend(context.Background(), tt.aiUpstream, tt.pCtx, tt.out)
