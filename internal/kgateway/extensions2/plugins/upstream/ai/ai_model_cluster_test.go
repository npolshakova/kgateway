...
func TestProcessAIUpstream_Empty(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
		Name: "test-cluster",
	}

	err := ProcessAIUpstream(ctx, nil, nil, cluster)
...
func TestProcessAIUpstream_OpenAI(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
		Name: "openai-cluster",
	}
	...
	model := "gpt-4"
	aiUpstream := &v1alpha1.AIUpstream{
	...
	err := ProcessAIUpstream(ctx, aiUpstream, secrets, cluster)
...
func TestProcessAIUpstream_Anthropic(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
...
func TestProcessAIUpstream_AzureOpenAI(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
...
func TestProcessAIUpstream_Gemini(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
		Name: "gemini-cluster",
	}
...
func TestProcessAIUpstream_VertexAI(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
...
func TestProcessAIUpstream_CustomHost(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
...
func TestProcessAIUpstream_MultiPool(t *testing.T) {
	ctx := context.Background()
	cluster := &envoy_config_cluster_v3.Cluster{
